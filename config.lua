...
if IsDuplicityVersion() then
    ...
    -- Use '/setslots' and '/remslots' commands for per-player overrides
    Config.Slots = 5

    -- Prefix for character identifiers (char#:identifier)
    Config.Prefix = "char"
else
    -- Camera position for the character selection scene
    Config.CamCoords = vector4(-1045.0, -2750.0, 21.5, 330.0)

    -- Camera FOV
    Config.CamFov = 40.0

    -- Ped preview position
    Config.PedCoords = vector4(-1045.0, -2745.0, 21.3, 150.0)

    -- Allow relog command
    Config.Relog = true

    -- Show last played date in UI
    Config.EnableLastPlayed = true

    -- Default nationality for UI display
    Config.DefaultNationality = 'Desconocida'

    -- Camera transition time (ms)
    Config.CamTransitionTime = 1000

    -- Default appearance for new characters (used by skin creator)
    Config.Default = {
        ["m"] = {
            ...
            eyebrows_2 = 0, eyebrows_1 = 0, eyebrows_3 = 0, eyebrows_4 = 0, eyebrows_5 = 0, eyebrows_6 = 0,
        ...
        ["f"] = {
            ...
            eyebrows_2 = 7, eyebrows_1 = 32, eyebrows_3 = 52, eyebrows_4 = 9, eyebrows_5 = -5, eyebrows_6 = -8,
            makeup_1 = 0, makeup_2 = 0, makeup_3 = 0, makeup_4 = 0,
            lipstick_1 = 0, lipstick_2 = 0, lipstick_3 = 0, lipstick_4 = 0,
            ears_1 = -1, ears_2 = 0,
            chest_1 = 0, chest_2 = 0, chest_3 = 0,
